...
class MovieMapperTest {
  ...
  @Test fun testFromMovieFavoriteEntityToMovieTrending() {
  ...
  @Test fun testFromMovieTrendingToMovieFavoriteEntity() {
    val movie = MovieTrending(
      id = 4123,
      title = "Avenger",
      overview = "Cool Movie",
